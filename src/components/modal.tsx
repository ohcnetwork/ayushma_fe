export default function Modal(props: {
    ...
    return (
        <div className={`inset-0 fixed z-10 flex items-center justify-center transition-all ${show ? "opacity-100 visible" : "opacity-0 invisible"}`}>
            ...
            <div className={`bg-white md:rounded-xl w-full md:w-[800px] h-full md:h-[500px] p-8 relative transition-all ${show ? "scale-100 opacity-100" : "scale-[0.8] opacity-0"} overflow-auto`}>
