...
export const API = {
    ...
    tests: {
        ...
        runs: {
            ...
            update: (suite_id: string, id: string, fields: Partial<TestRun>) => request(`tests/suites/${suite_id}/runs/${id}`, "PATCH", fields),
    ...
    users: {
        ...
        list: (filters: { ordering: string, offset?: number, limit?: number ,search?: string, is_staff?: boolean | null, is_reviewer?: boolean | null, allow_key?: boolean | null} = { ordering: "-created_at" }) => request(`users`, "GET", filters),
