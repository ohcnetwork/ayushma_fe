...
export default function Page({
  ...
  return (
    <div ref={reportTemplateRef}>
      ...
      <div className="border border-secondaryActive bg-primary p-4 rounded-lg my-4">
        ...
        <div className="mt-4">
          <b className="text-xs text-primaryLightfont">Prompt:</b>
          <br />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-5 gap-4 border border-secondaryActive bg-primary p-3 rounded-lg my-4">
        {feedbackStats.total !== -1 ? (
          <>
            {" "}
            <div className="flex flex-col items-center">
              <div className="text-md font-bold mb-2">Total Feedback</div>
              <div className="text-2xl font-bold text-primaryLightfont mb-1">
                {feedbackStats.total}
              </div>
            </div>
            <div className="flex flex-col items-center">
              <div className="text-md font-bold mb-2">Average Feedback</div>
              <div className="text-sm font-bold text-primaryLightfont mb-1">
                <p className="text-primaryLightfont">
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-primaryLightfont">{test.answer}</p>
                    ...
                    if (
                      ...
                      return (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="text-xs bg-secondaryActive text-primaryLightfont px-2 py-0.5 rounded-md hover:bg-gray-300"
                        >
                          {doc.title}
                        </a>
                      );
                      ...
                      return (
                        <div className="text-xs bg-secondaryActive text-primaryLightfont px-2 py-0.5 rounded-md hover:bg-gray-300">
                          {doc.title}
                        </div>
                      );
                    else return null;
          ...
          {test.test_question?.documents?.map((document) => (
            <div
              className="flex items-center mb-2 border border-secondaryActive rounded-lg bg-primary"
            ...
            >
              ...
              >
                <div className="flex items-center justify-center">
                  <i className="fas fa-paperclip mr-2 text-primaryLightfont"></i>
                  <div className="text-primaryLightfont">{document.title}</div>
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
            <div>
              ...
              <p
                className={`font-bold text-center sm:text-left text-xl text-primaryLightfont ${test.cosine_sim >= 0.5 ? "text-green-500" : "text-red-500"
                  }`}
              >
            ...
            <div>
              ...
              <p
                className={`font-bold text-center sm:text-left text-xl text-primaryLightfont ${test.bleu_score >= 0.5 ? "text-green-500" : "text-red-500"
                  }`}
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
            <div>
              ...
              <p className="font-bold text-center sm:text-left text-xl text-primaryLightfont">
            ...
            <div className="flex flex-col sm:flex-row">
              <div className="flex flex-col">
                ...
                <div className="text-sm font-bold text-primaryLightfont mb-1 flex justify-center sm:block">
                  <p className="text-primaryLightfont">
            ...
            {showAddFeedbackSection && (
              <>
                <div>
                  ...
                  <p className="text-primaryLightfont">{feedbackTestResult.answer}</p>
                </div>
                      ...
                      >
                        <div className="flex justify-between items-center">
                          ...
                          <div className="flex items-center">
                            ...
                            <div className="text-primaryLightfont">
                        ...
                        <div className="flex items-center">
                          ...
                          <p className="text-primaryLightfont">{feedback.notes}</p>
                        </div>
                      </div>
                    ))}
                  {!feedbackItemsLoading &&
                    feedbackItems &&
                    feedbackItems.length == 0 && (
                      <div className="text-center text-primaryLightfont">
                        No feedback yet
                      </div>
                    )}
                </div>
              ...
              <>
                ...
                <div className="flex flex-col mt-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-primaryLightfont">Rating</div>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="text-primaryLightfont">Note</div>
                  </div>
